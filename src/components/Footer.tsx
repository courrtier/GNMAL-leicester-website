      ...
      <div className="max-w-7xl mx-auto space-y-24">
            ...
            <div className="flex gap-4">
              {socialLinks.map(({ Icon, href, label }) => (
                <a
                  ...
                  aria-label={`GNMAL Leicester on ${label}`}
                  className="w-10 h-10 rounded-full bg-accent flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all shadow-sm"
                >
                  <Icon size={20} />
                </a>
              ))}
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                ...
                <li><Link to="/programs" className="text-sm font-bold text-text-muted hover:text-primary transition-colors flex items-center justify-between group">Programs <ArrowUpRight size={14} className="opacity-0 group-hover:opacity-100 transition-opacity" /></Link></li>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex flex-col gap-1">
                  ...
                  <a href={`mailto:${CONTACT_EMAIL}`} className="text-sm font-bold text-text-main hover:text-primary transition-colors">{CONTACT_EMAIL}</a>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="block px-6 py-3 bg-secondary text-white rounded-xl text-xs font-bold text-center shadow-lg shadow-secondary/10 hover:shadow-secondary/20 transition-all"
                >
                  WhatsApp Community
                </a>
                <Link
                  to="/membership"
                  className="block px-6 py-3 bg-primary text-white rounded-xl text-xs font-bold text-center shadow-lg shadow-primary/10 hover:shadow-primary/20 transition-all"
                >
                  Support Circles
                </Link>
              </div>
        ...
        <div className="pt-12 border-t border-border-std flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8 text-[10px] font-bold uppercase tracking-[0.2em] text-text-muted">
            ...
            <a href={`mailto:${CONTACT_EMAIL}`} className="hover:text-text-main transition-colors">Email</a>
          </div>
        </div>
      </div>
    </footer>
